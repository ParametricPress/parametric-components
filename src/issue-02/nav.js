    ...
    return (
      <div className="parametric-article-nav">
          ...
          <div className="parametric-issue-toc" style={{
            ...
            <div onClick={this.handleContents} style={{ cursor: 'pointer', textAlign: 'right', fontFamily: 'Graphik Web', position: 'relative', top: '-1em', fontSize: 36, marginBottom: 0 }}>
              ✖
            </div>
            {
            ...
            <div style={{textAlign: 'right'}}>
              <div style={{marginTop: '2em', marginBottom: '1em', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end'}}>
                <div style={{fontFamily: 'Graphik Web', fontWeight: 500}}>
                  <a style={{color: '#222'}} href={`/issue-02/editors-note/`}>Editors’ Note</a>
                </div>
              </div>
            </div>
          </div>
